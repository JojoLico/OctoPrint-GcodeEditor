    ...
    function GcodeEditorViewModel(parameters) {
        ...
        self.cutGcode = ko.pureComputed(function() {
            ...
            for(let line of data) {
                ...
                // In case of custom Z nozzle movements at the beginning, let's assume there is a comment at the end of the line, this will create a NaN
                if (height > gcodeHeightP  && process === false && !(line.includes('NaN'))) {
